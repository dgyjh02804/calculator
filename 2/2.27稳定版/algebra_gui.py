...
class AlgebraCalculatorGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("代数表达式计算器 V1.34.1 --------------------绝对值方程 --------------------   构建时间: 2.27  ")
        ...
        self.equation_categories = {
            ...
            "绝对值方程": [
                ...
                ("|x-1|=3", "x = 4 或 -2"),
                ("|x|+|y|=1",
                 "当 x ≥ 0 且 y ≥ 0 时，解为：x = -y+1, y = -x+1\n当 x ≥ 0 且 y < 0 时，解为：x = y+1, y = x-1\n当 x < 0 且 y ≥ 0 时，解为：x = y-1, y = x+1\n当 x < 0 且 y < 0 时，解为：x = -y-1, y = -x-1"),
                ("|x+1|=y", "当 x+1 ≥ 0 时，解为：x = y-1, y = x+1\n当 x+1 < 0 时，解为：x = -y-1, y = -x-1"),
            ],
            "3.7": [
            ...
            ("x^2+y^2+4x-4y=0; x^2+y^2+2x-12=0", "x = -2+4/5√(10), y = 2+2/5√(10) 或 x = -2-4/5√(10), y = 2-2/5√(10)"),
